    ...
    <div class="tabcontents">
      <div class="tab-pane active" id="doc-profile">
       ...
       <fieldset class="his">
        ...
        <label style=" margin-bottom: -3px;">  Phone </label> 
        <input type="phone" value="<?php echo $result['phone'];?>" data-type="phone" data-trigger="change" data-required="true"   name="phone"   >
