...
<!-- <div class="comnt_plftmain">
        ...
        <input type="radio" <?php if($rtng['overall']==1){echo "checked ";}  ?>  name="rating" value="0" checked  /><span id="cmnt_hide"></span>
        <input type="radio" <?php if($rtng['overall']==1){echo "checked ";}  ?>  name="rating" value="1" /><span></span>
        <input type="radio" <?php if($rtng['overall']==2){echo "checked ";}  ?>  name="rating" value="2" /><span></span>
        <input type="radio" <?php if($rtng['overall']==3){echo "checked ";}  ?>  name="rating" value="3" /><span></span>
        <input type="radio" <?php if($rtng['overall']==4){echo "checked ";}  ?>  name="rating" value="4" /><span></span>
        <input type="radio" <?php if($rtng['overall']==5){echo "checked ";}  ?>  name="rating" value="5" /><span></span>
        </div>
        ...
        <input type="radio" <?php if($rtng['beside']==1){echo "checked ";}  ?> name="rating2" value="0" checked /><span id="cmnt2_hide"></span>
        <input type="radio" <?php if($rtng['beside']==1){echo "checked ";}  ?> name="rating2" value="1"  /><span></span>
        <input type="radio" <?php if($rtng['beside']==2){echo "checked ";}  ?> name="rating2" value="2"  /><span></span>
        <input type="radio" <?php if($rtng['beside']==3){echo "checked ";}  ?> name="rating2" value="3" /><span></span>
        <input type="radio" <?php if($rtng['beside']==4){echo "checked ";}  ?> name="rating2" value="4"  /><span></span>
        <input type="radio" <?php if($rtng['beside']==5){echo "checked ";}  ?> name="rating2" value="5"  /><span></span>
        </div>
        ...
        <input type="radio" <?php if($rtng['waiting']==1){echo "checked ";}  ?> name="rating3" value="0" checked /><span id="cmnt3_hide"></span>
        <input type="radio" <?php if($rtng['waiting']==1){echo "checked ";}  ?> name="rating3" value="1"  /><span></span>
        <input type="radio" <?php if($rtng['waiting']==2){echo "checked ";}  ?> name="rating3" value="2" /><span></span>
        <input type="radio" <?php if($rtng['waiting']==3){echo "checked ";}  ?> name="rating3" value="3" /><span></span>
        <input type="radio" <?php if($rtng['waiting']==4){echo "checked ";}  ?> name="rating3" value="4" /><span></span>
        <input type="radio" <?php if($rtng['waiting']==5){echo "checked ";}  ?> name="rating3" value="5"  /><span></span>
        </div>
        </div>
        </div>
        </div>
        ...
        <label style="width: 160px; float: left;"> <input type="button" value="submit" class="cmnt_btn submit" <?php  ?> id="submit"></label>
