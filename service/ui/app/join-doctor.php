...
<div class="container section_wrapper">
   ...
   <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: right;">
         <a href="<?php echo WEB_ROOT;?>index.php/join/patient">Not a Doctor? Click here </a>
      </div>
   </div>
   ...
   <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="signup_nw">
               <h1> You’ll love being on DocVisits </h1>
               <ul>
                  <li>
                     <h2> You’ll love being on DocVisits </h2>
                     Access DocVisits network of more than 5 million patients. 
                  </li>
                  <li>
                     <h2> You’ll love being on DocVisits </h2>
                     Let patients schedule appointments with you instantly, 24-7, from DocVisits and from your practice website.
                  </li>
                  <li>
                     <h2> You’ll love being on DocVisits </h2>
                     Access DocVisits network of more than 5 million patients. 
                  ...
                  <li>
                     <h2> You’ll love being on DocVisits  </h2>
                     Let patients schedule appointments with you instantly, 24-7, from docvisits.com and from your practice website.
                  </li>
               </ul>
            </div>
         </div>
