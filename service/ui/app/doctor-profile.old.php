...
<main id="main" class="tg-haslayout">
  <section class="tg-main-section tg-haslayout">
    <div class="container">
      <div class="row">
        <input type="text" data-beatpicker="true" data-beatpicker-format="['YYYY','MM','DD']" id="gotoDate" placeholder="Go to Date" data-beatpicker-id="myDatePicker" style="width: 35%;" /> 
        <div class="dctr_mbr_mdl">
          <div class="dctr_mbr_lft" style="float: left;padding: 0;width: 100%;">
  ...
  <div class="modal-dialog">
    ...
    <div class="row">
      <div class="inputpop">
        ...
        <div class="col-md-offset-2 col-md-8">
          <input type="text" name="patEmail" id="patEmail" title="Hospital is required!" required="" placeholder="doc@docvisits.com" class="rounded3">
        </div>
      </div>
    </div><br />
    <div class="row">
