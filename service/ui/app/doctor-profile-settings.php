...
<main id="main" class="tg-haslayout">
       ...
       <div class="dctr_mbr_mdl">
        <div class="dctr_mbr_lft">
         <div class="dctr_mbr_tbl">
          <ul class="tabs" id="docTab" style="border-bottom: none">
        ...
        <div class="row">
         ...
         <div class="col-md-4">
           <div class="form-group">
            <input type="text" placeholder="zipcode" value="<?php echo $result['zipcode'];?>" data-trigger="change" data-required="true" id="password" name="code" class="input-block-level">
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <input type="button" id="doc-setting" class="tg-btn findDoctors" name="Confirm" value="Save"></div>
      </fieldset>
    </form>
  ...
  <div class="tab-pane his" id="doc-details">
    ...
    if(empty($result)){
     ?>
     <!-- <div id="doc-setting-error" >no</div>-->
     <form id="doc-details-form" name="doc-setting-form" data-parsley-validate>
      <div id="doc-success1" style="display:none" class="alert alert-success">
       <p align="center">Changes Saved!!</p>
     </div>
     <div class="row"><div class="col-md-6">First Column</div><div class="col-md-6">Second Column</div></div>
     <div class="row">
       <div class="col-md-6">
...
<fieldset>
  <div class="row">
   ...
   <div class="col-md-4">
     ...
     ?>
     <div id="spcl1">
       <img class="addNewSpcl" title="Click to add more Languages" alt="Monday" style="cursor:pointer;float:right;" src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon4.jpg">
...
<div class="row">
 ...
 <div class="col-md-4">
   <div class="form-group">
     <img class="addNewLang" title="Click to add more Languages" alt="Monday" style="cursor:pointer;float:right;" src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon4.jpg">
     <div id="lang">
      <?php 
...
<div class="row">
 ...
 <div class="col-md-4">
   <div class="form-group"><textarea data-trigger="change" data-required="true" placeholder="Board Certifications" name="Board" id="" class="input-block-level" style="min-height:50px;" ><?php echo $result[BoardCertifications];?></textarea>
   </div>
 </div>
</div>
<div class="row">
 ...
 <div class="col-md-4">
   <div class="form-group"><textarea data-trigger="change" data-required="true" placeholder="Awards and Publications" name="Awards" id="" class=  "input-block-level" style="min-height:50px;" ><?php echo $result[Awards];?></textarea>
   </div>
 </div>
</div>
<div class="row">
 ...
 <div class="col-md-4">
   <div class="form-group"><textarea data-trigger="change" data-required="true" placeholder="Professional Memberships" name="Memberships" id="" class=  "input-block-level" style="min-height:50px;" ><?php echo $result[ProfessionalMemberships];?></textarea>
   </div>
 </div>
</div>
<div class="row">
 ...
 <div class="col-md-4">
   <div class="form-group"><div class="dInsurance">
     <img class="addNewInsurence" title="Click to add more Languages" alt="Monday" style="cursor:pointer;float:right;" src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon4.jpg">
     <?php
     ...
     for($i=0;$i<$spclen;$i++){
      $selected=$spcli[$i][id];
      ?>
      <select class="input-block" required name="insuranceSelect[]" id="dInsuranceSelect">
        <option value="">Select Insurance</option>
        <?php $scad->listbox('insurance','id','name','`parent_id`=0','`name` ASC',$selected); ?>
      </select>
      <?php } ?>
    </div>
    <div id="dInsurence-here"></div>

  </div>
</div>
</div>
<div class="col-md-3">
  <input type="button" id="doc-detail1" class="tg-btn findDoctors" name="Confirm" value="Save"></div>
</fieldset>
</form>
</div>
<?php } ?>
...
<div class="tab-pane his" id="doc-pass1">
  <form  id="doc-setting-pass" name="doc-setting-form" >
   ...
   <fieldset>
     ...
     <div class="row">
       <div class="col-md-3">
         <input type="button" id="doc-pass" class="tg-btn findDoctors" name="Confirm" value="Save"></div>
       </div>
     </div>
   </fieldset>
 </form>
