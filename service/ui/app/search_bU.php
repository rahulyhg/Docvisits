...
<div class="container">
   <div class="">
               ...
               <div class='row'>
                 <div class='col-md-3 col-sm-6 col-xs-12'>
                  ...
                  <div class="category-select">
                     <input type="text" id="docName" name="docName" placeholder="Doctor Name" value="<?php echo $docName;?>" class="input-block-level" style="min-height:36px;" >
                  </div>
               </div>
               <div class='col-md-3 col-sm-6 col-xs-12'>
                  <div class="section">
      ...
      <div class="row" id="result_area">
         <div class="col-md-12 data-fetch">
            <div class="row">
...
function stickIt() {
 ...
 if (($(window).scrollTop() >= (orgElementTop)) && (($(window).scrollTop() + $('.original').height()) <= (limitElementTop))) {
  ...
  alert("inside fixed ---- 2");
    // not scrolled past the menu; only show the original menu.
    $('.cloned').hide();
    $('.original').css('visibility','visible');
    $('.map_cate').css({'z-index':'0','position':'absolute',top:0,width:'auto'}).show();
    
 }
 if((($(window).scrollTop() + $('.original').height() + $('.map_cate').height()) >= (limitElementTop))){
  alert("inside fixed ---- 11");
  $('.map_cate').css({'z-index':'0','position':'absolute',top:0,width:'auto'}).show();
}
}
</script>