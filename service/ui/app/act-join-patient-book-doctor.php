...
if(!empty($patientData)){
	...
	if($result==''){
		...
		$mailTemplate = '<div><h3 style="padding:12px;">Congratulations...!</h3><div style="padding:12px;font-family:Arial, Helvetica, sans-serif;font-size:14px;">You are successfully registered with DocVisits.</div>';
