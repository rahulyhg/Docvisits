...
if ($_POST['page']) {
  parse_str($search);
    ...
    $last_btn     = true;
    $start        = $page * $per_page;
     $result = $scad->searchDoctorLimit($srchSpeciality,$srchZipcode,$insuranceSelect,$subInsuranceSelect,$srchReason,$gender,$start,$per_page);
     $result1 = $scad->searchDoctor($srchSpeciality,$srchZipcode,$insuranceSelect,$subInsuranceSelect,$srchReason,$gender);
