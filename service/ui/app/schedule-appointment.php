...
<input type="hidden" name="insuranceSelect" id="insuranceSelect" value="<?php echo $insuranceSelect;?>"/>
<input type="hidden" name="subInsuranceSelect" id="subInsuranceSelect" value="<?php echo $insuranceSelect;?>"/>
...
<div class="place-select">
  <input type="text" id="srchReason" name="srchReason" placeholder="Condition" value="" class="input-block-level" style="min-height:36px;" >
</div>
<div class="section italic">
 ...
 <div class="rad-but ex">
   ...
   if(!$_SESSION['userID']){
    ?>
    <input name="regStatus" id="newSch" type="radio" value=""> I'm new to DocVisits <br>
    <?php
  }
  ?>
  <input name="regStatus" id="nextSh" type="radio" value=""> I've used DocVisits before
  <div class="clearBoth"></div>
</div>
</div>
</div>
