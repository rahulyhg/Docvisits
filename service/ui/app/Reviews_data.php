...
for($i=0;$i<$length;$i++){
 ...
 $end  = count($result1);*/
   ...
   <div class="prlf_close"><a href="http://demo.techware.co.in/docvisits/patient/profile#"><img alt="" src="./Find a Doctor - Doctor Reviews &amp; Ratings   Book Online Instantly ? DocVisits_files/profile_close.png"></a></div>
