...
//           });
 ...
 $(".setVecation").click(function(){
  html=''+'<div class="row shows" ><div class="col-md-2 col-sm-6 col-xs-12"> <fieldset class="account-text end" style="border: none;"><input type="text" data-trigger="mouseleave" data-required="true" data-beatpicker="true" name="dob" id="dob" placeholder="DD-MM-YY" class="input-block-level startdate date-field-required" style="min-height:30px;"/></fieldset></div><div class="col-md-2 col-sm-6 col-xs-12"> <fieldset class="account-text end" style="border: none;"><input type="text" data-trigger="mouseleave" data-required="true" data-beatpicker="true" name="dob" id="dob" placeholder="DD-MM-YY" class="input-block-level enddate date-field-required" style="min-height:30px;"/></fieldset></div><div class="col-md-2 col-sm-6 col-xs-12"> <fieldset class="account-text end" style="border: none;"><input type="text" placeholder="" data-type="text" value="" data-trigger="change" data-required="true" class="input-block-level starttime timeformat date-field-required" name="text" id="text" style="min-height:30px;"></fieldset></div><div class="col-md-2 col-sm-6 col-xs-12"> <fieldset class="account-text end" style="border: none;"><input type="text" placeholder="" data-type="text" value="" data-trigger="change" data-required="true" class="input-block-level endtime timeformat date-field-required" name="text" id="text" style="min-height:30px;"></fieldset></div><div class="col-md-2 col-sm-6 col-xs-6"><div class="actions"><a href="javascript:void(0);"> <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon5.jpg" style="cursor:pointer;" class="savevecation" alt=""></a></div><div clas="actions"><a href="javascript:void(0);"><img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon2.jpg" style="cursor:pointer;margin-left:3px;" class="change2" alt=""></a></div></div></div>';
...
function Getbrvalue(trg){
    ...
    $(function() {
                    ...
                    <section class="tg-main-section tg-haslayout">
                      <div class="container">
                        <div class="row">
                          ...
                          <ul data-persist="true" class="tabs" style="border-bottom:none">
                       ...
                       foreach($day as $value){
                         ...
                         <div  class="row">
                          ...
                          <div class="col-md-4 col-sm-4 col-xs-4">
                            <fieldset class="account-text registration days" style="border: none">                              
                       ...
                       <div class="row" style="padding-top: 20px;">
                         <div class="col-xs-8 text-center">
                           <input type="button" onclick="Getvalue()" class="tg-btn " name="Update" value="Update">
                         </div></div>
                       </div>
                       <div id="doc-pass1" style="display: block;">
                         <div class="row"><div class="col-md-8">
                           <div id="update_error1" style="margin-top:20px;display:none;text-align:center;" class="alert alert-error">Update Failed.</div>
             ...
             <div class="row shows" style="display:none !important;">
              <form>
               <div class="col-md-3 col-sm-3 col-xs-12">
                <label>
       ...
       if(empty($doc[0][Tue])){
         ...
         <div class="row shows" >
           ...
           <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Thu" name="text" id="text" style="min-height:30px;"></fieldset></div>
           <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Thu" name="text" id="text" style="min-height:30px;"></fieldset> </div>
         ...
         if($b==1){
           ...
           <div  class="row exist">
             ...
             <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $starttu[$i]?> </fieldset></div>

             <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $endstu[$i]?> </fieldset></div>
             <div class="col-md-3 col-sm-3 col-xs-6">
              <div class="actions">
                <a href="javascript:void(0);"> 
                  <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon1.jpg" style="cursor:pointer;" class="change" alt="">
        ...
        <div class="row shows" style="display:none">
         ...
         <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $starttu[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Tue" name="text" id="text" style="min-height:30px;"></fieldset></div>
         <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $endstu[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Tue" name="text" id="text" style="min-height:30px;"></fieldset></div>
         <div class="col-md-3 col-sm-3 col-xs-6"> 
          <div class="actions">
            <a href="javascript:void(0);">
              <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon5.jpg" onclick="Getbrvalue($(this))" style="cursor:pointer;" class="change1" alt="">
      ...
      if(empty($doc[0][Wed])){
       ...
       <div class="row shows" >
         ...
         <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Wed" name="text" id="text" style="min-height:30px;"></fieldset></div>
         <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Wed" name="text" id="text" style="min-height:30px;"></fieldset></div>
         <div class="col-md-3 col-sm-3 col-xs-6"> 
          <div class="actions">
            <a href="javascript:void(0);">
    ...
    if($b==1){
     ...
     <div class="row exist" >
       ...
       <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $startw[$i]?> </fieldset></div>

       <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $endsw[$i]?></fieldset> </div>
       <div class="col-md-3 col-sm-3 col-xs-6"> 
        <div class="actions">
          <a href="javascript:void(0);">
            <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon1.jpg" style="cursor:pointer;" class="change" alt="">
    ...
    <div class="row shows" style="display:none">
     ...
     <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $startw[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Wed" name="text" id="text" style="min-height:30px;"></fieldset></div>
     <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $endsw[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Wed" name="text" id="text" style="min-height:30px;"></fieldset></div>
     <div class="col-md-3 col-sm-3 col-xs-6"> 
      <div class="actions">
        <a href="javascript:void(0);"> 
          <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon5.jpg" onclick="Getbrvalue($(this))" style="cursor:pointer;" class="change1" alt="">
  ...
  if($i==($len-1))
  {
    ...
    if($b==1){
     ...
     <div class="row exist" >
       ...
       <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $startt[$i]?></fieldset> </div>

       <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $endst[$i]?></fieldset> </div>
       <div class="col-md-3 col-sm-3 col-xs-6">  
        <div class="actions">
          <a href="javascript:void(0);">
            <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon1.jpg" style="cursor:pointer;" class="change" alt=""> 
        ...
        <div class="row shows" style="display:none">
         ...
         <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $startt[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Thu" name="text" id="text" style="min-height:30px;"></fieldset></div>
         <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $endst[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Thu" name="text" id="text" style="min-height:30px;"></fieldset></div>
         <div class="col-md-3 col-sm-3 col-xs-6">  
          <div class="actions">
            <a href="javascript:void(0);">
              <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon5.jpg" onclick="Getbrvalue($(this))" style="cursor:pointer;" class="change1" alt="">
      ...
      if($i==($len-1))
      {
        ...
        if(empty($doc[0][Fri])){
         ...
         <div class="row shows" >
           ...
           <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Fri" name="text" id="text" style="min-height:30px;"></fieldset></div>
           <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Fri" name="text" id="text" style="min-height:30px;"></fieldset></div>
           <div class="col-md-3 col-sm-3 col-xs-6">  
            <div class="actions">
              <a href="javascript:void(0);">
        ...
        if($b==1){
         ...
         <div class="row exist" >
           ...
           <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $startf[$i]?> </fieldset></div>

           <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $endsf[$i]?> </fieldset></div>
           <div class="col-md-3 col-sm-3 col-xs-6">  
            <div class="actions">
              <a href="javascript:void(0);">
                <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon1.jpg" style="cursor:pointer;" class="change" alt=""> 
          ...
          <div class="row shows" style="display:none">
           ...
           <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $startf[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Fri" name="text" id="text" style="min-height:30px;"></fieldset></div>
           <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $endsf[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Fri" name="text" id="text" style="min-height:30px;"></fieldset></div>
           <div class="col-md-3 col-sm-3 col-xs-6">  
            <div class="actions">
              <a href="javascript:void(0);">
                <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon5.jpg" onclick="Getbrvalue($(this))" style="cursor:pointer;" class="change1" alt="">
        ...
        if($i==($len-1))
        {
          ...
          if(empty($doc[0][Sat])){
           ...
           <div class="row shows" >
             ...
             <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Sat" name="text" id="text" style="min-height:30px;"></fieldset></div>
             <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Sat" name="text" id="text" style="min-height:30px;"></fieldset></div>
             <div class="col-md-3 col-sm-3 col-xs-6">  
              <div class="actions">
                <a href="javascript:void(0);">
          ...
          if($b==1){
           ...
           <div class="row exist" >
             ...
             <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $startsa[$i]?></fieldset> </div>

             <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $endssa[$i]?></fieldset> </div>
             <div class="col-md-3 col-sm-3 col-xs-6">  
              <div class="actions">
                <a href="javascript:void(0);">
                  <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon1.jpg" style="cursor:pointer;" class="change" alt=""> 
            ...
            <div class="row shows" style="display:none">
             ...
             <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $startsa[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Sat" name="text" id="text" style="min-height:30px;"></fieldset></div>
             <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $endssa[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Sat" name="text" id="text" style="min-height:30px;"></fieldset></div>
             <div class="col-md-3 col-sm-3 col-xs-6">  
              <div class="actions">
                <a href="javascript:void(0);">
                  <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon5.jpg" onclick="Getbrvalue($(this))" style="cursor:pointer;" class="change1" alt="">
          ...
          if($i==($len-1))
          {
            ...
            if(empty($doc[0][Sun])){
             ...
             <div class="row shows" >
               ...
               <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Sun" name="text" id="text" style="min-height:30px;"></fieldset></div>
               <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Sun" name="text" id="text" style="min-height:30px;"></fieldset></div>
               <div class="col-md-3 col-sm-3 col-xs-6">  
                <div class="actions">
                  <a href="javascript:void(0);">
            ...
            if($b==1){
             ...
             <div class="row exist" >
               ...
               <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $startsu[$i]?></fieldset> </div>

               <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><?php echo $endssu[$i]?></fieldset> </div>
               <div class="col-md-3 col-sm-3 col-xs-6">  
                <div class="actions">
                  <a href="javascript:void(0);">
                    <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon1.jpg" style="cursor:pointer;" class="change" alt=""> 
              ...
              <div class="row shows" style="display:none">
               ...
               <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $startsu[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Sun" name="text" id="text" style="min-height:30px;"></fieldset></div>
               <div class="col-md-3 col-sm-3 col-xs-12"> <fieldset class="account-text registration days" style="border: none;"><input type="text" value="<?php echo $endssu[$i]?>" placeholder="" data-type="text" data-trigger="change" data-required="true" class="input-block-level timeformat1Sun" name="text" id="text" style="min-height:30px;"></fieldset></div>
               <div class="col-md-3 col-sm-3 col-xs-6">  
                <div class="actions">
                  <a href="javascript:void(0);">
                    <img src="<?php echo WEB_ROOT?>service/public/images/tab_clum2_icon5.jpg" onclick="Getbrvalue($(this))" style="cursor:pointer;" class="change1" alt="">
          ...
          <div id="doc-imageupload" style="display: block;">
            ...
            <div style="margin:0;" class="row vecation">
            </div>
            <?php 
            if(!empty($vecation)){
            ...
            for($jk=0;$jk<$leng;$jk++){
             ...
             <div style="margin:0;" class="row">
               ...
               <div class="col-md-2 col-sm-6 col-xs-12 "> 
                <fieldset class="account-text end" style="border: none;">
