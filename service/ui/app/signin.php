...
<?php /*?><div class="container section_wrapper">
         <div class="row">
            <div class="col-md-6">
               ...
               <div class="patient">
               <h2>Have a Doc Visits Account</h2>
               ...
               <div class="between"></div>
               	<div class="patient">
                  <h2>Do not have Doc Visits Account!</h2>
                  <p>Sign up for a Doc Visits account to book an appoiment right<br>
        ...
        <div class="col-md-6">
        	...
        	<form id="signin-form" name="signin-form">
                <fieldset class="account-text accotxt">
                    <label>
                        Email<br>
                        <input type="email" placeholder="Email Address" data-type="email" data-trigger="change" data-required="true" class="input-block-level"  name="email"  id="email">		        </label>
                    <label>
                        Password<br>
                        <input type="password" placeholder="Password" data-trigger="change" data-required="true" id="password" name="password" class="input-block-level">
                    </label>
