        ...
        <div class="tab-pane active" id="doc-profile">
         ...
         <fieldset>
          ...
          <div class="row">
           ...
           <div class="col-md-4">
             <div class="form-group">
              <input type="email" readonly value="<?php echo $result['email'];?>" data-type="email" data-trigger="change" data-required="true" placeholder="Email"  name="email"   >
            </div>
          </div>
        </div>
        <div class="row">
         ...
         <div class="col-md-4">
           <div class="form-group">
             <input type="tel" maxlength="10" value="<?php echo $result['phone'];?>" data-type="phone" data-trigger="change" data-required="true" placeholder="use the format XXX-XXX-XXXX"  name="phone"  id="phone" >
           </div>
         </div>
       </div>
       <div class="row">
         ...
         <div class="col-md-4">
           <div class="form-group">
            <input class="date-field-required" type="text"value="<?php echo date("m/d/Y", strtotime($result['dob']));?>" data-trigger="mouseleave" data-required="true" data-beatpicker="true" name="dob" id="dob" placeholder="MM/DD/YYYY"  data-beatpicker-format="['MM','DD','YYYY'],separator:'/'" /> 
          </div>
        </div>
      </div>
