    ...
    $.extend(GeoComplete.prototype, {
        ...
        $.proxy(this.placeChanged, this)
            ...
            this.$input.bind("geocode", $.proxy(function () {
                if (this.$input.val() == "") {
                    if ($("#hdnCurrentAddress").val() != "")
                        this.$input.val($("#hdnCurrentAddress").val());
                    else if ($("#hdnCurrentLocation").val() != "")
                        this.$input.val($("#hdnCurrentLocation").val());
                }
                this.find();
            }, this));
