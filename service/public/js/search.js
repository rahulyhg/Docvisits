...
function loadData(page) {
  ...
  if(!Data) {
    Data="docSpeciality=&docZip=&insuranceSelect=&srchReason=0&srchReason1=&gender=0";     
  }
  $.ajax({
    type: "POST",
    dataType:'text json',
    ...
    data: {
      ...
      //	  alert(msg.noOfPages);
      if(msg.noOfPages>5) {
	     //	  alert("set Map height to 1303px");
...
function modalPopup(){
  $(".dr_bkonline").click(function(e){
      ...
      $.ajax({
        ...
        var pro_img = (outData.imageName) ? outData.imageName : 'no_image.jpg';
          ...
          html += '<div class="col-md-12 col-sm-12 col-xs-12" style=" background-color: #F2F2F2;border: 1px solid #e6e6e6;min-height:195px;">';
          html += '<div class="bkng_popup_adrs_mainn">';
          html += '<div class="col-md-6 col-sm-6 col-xs-6"><img src="'+SITEURL1+'service/public/z_uploads/doctor/small/'+pro_img+'" align="left" alt="" style="padding-top:30px;"></div>';
  ...
  $(".dr_viewProfile").click(function(e){
   // alert("in View Profile click function");
      //e.preventDefault();
      var x=$(this).position();
      //alert("Top position: " + x.top + " Left position: " + x.left);
      $(".con").html('');
      ...
      $.ajax({
        ...
        var pro_img = (outData.imageName) ? outData.imageName : 'no_image.jpg';
          ...
          html += '<div class="col-md-6 col-sm-6 col-xs-6">';
          html += '<h1>'+outData.firstname+' '+outData.lastname+'</h1>';
          html += '<p><b> '+outData.speciality+' </b> <br> '+(outData.description).substring(0,200)+'.... </p>';
          html += '</div>';
          html += '</div>';
          html += '</div>';       
          //html += '<div class="col-md-6 col-sm-6 col-xs-6"><div id="popMap" class="bkng_online_popup_map"></div></div>';
          ...
          html += '<div class="bkng_popup_adrs_mainn">';
          html += '<div class="col-md-6 col-sm-6 col-xs-6"><h5 style="text-transform:none;">Address</h5></div>';
          html += '<div class="col-md-6 col-sm-6 col-xs-6">';
          html += '<p style="padding-top:10px"><b> '+outData.address+'</b></p>';
          html += '</div>';
          html += '</div>';
          html += '</div>';       
          //html += '<div class="col-md-6 col-sm-6 col-xs-6"><div id="popMap" class="bkng_online_popup_map"></div></div>';
          ...
          html += '<div class="col-md-12 col-sm-12 col-xs-12" style=" background-color: #F2F2F2;border: 1px solid #e6e6e6;">';
          html += '<div class="bkng_popup_adrs_mainn">';
          html += '<div class="col-md-6 col-sm-6 col-xs-6"><h5 style="text-transform:none;">Education</h5></div>';
          html += '<div class="col-md-6 col-sm-6 col-xs-6">';
          html += '<p style="padding-top:10px"><b> '+outData.Education+'</b></p>';
          html += '</div>';
          html += '</div>';
          html += '</div>';       
          //html += '<div class="col-md-6 col-sm-6 col-xs-6"><div id="popMap" class="bkng_online_popup_map"></div></div>';
          ...
          html += '<div class="col-md-12 col-sm-12 col-xs-12" style=" background-color: #F2F2F2;border: 1px solid #e6e6e6;">';
          html += '<div class="bkng_popup_adrs_mainn">';
          html += '<div class="col-md-6 col-sm-6 col-xs-6"><h5  style="text-transform:none;">Hospital Affiliations</h5></div>';
          html += '<div class="col-md-6 col-sm-6 col-xs-6">';
          html += '<p style="padding-top:10px"><b> '+outData.HospitalAffiliations+'</b></p>';
          html += '</div>';
          html += '</div>';
          html += '</div>';       
          //html += '<div class="col-md-6 col-sm-6 col-xs-6"><div id="popMap" class="bkng_online_popup_map"></div></div>';
          ...
          html += '<div class="col-md-12 col-sm-12 col-xs-12" style=" background-color: #F2F2F2;border: 1px solid #e6e6e6;">';
          html += '<div class="bkng_popup_adrs_mainn">';
          html += '<div class="col-md-6 col-sm-6 col-xs-6"><h5  style="text-transform:none;">Board Certifications</h5></div>';
          html += '<div class="col-md-6 col-sm-6 col-xs-6">';
          html += '<p style="padding-top:10px"><b> '+outData.BoardCertifications+'</b></p>';
          html += '</div>';
          html += '</div>';
          html += '</div>';       
          //html += '<div class="col-md-6 col-sm-6 col-xs-6"><div id="popMap" class="bkng_online_popup_map"></div></div>';
          ...
          html += '<div class="col-md-12 col-sm-12 col-xs-12" style=" background-color: #F2F2F2;border: 1px solid #e6e6e6;">';
          html += '<div class="bkng_popup_adrs_mainn">';
          html += '<div class="col-md-6 col-sm-6 col-xs-6"><h5  style="text-transform:none;">Professional Memberships</h5></div>';
          html += '<div class="col-md-6 col-sm-6 col-xs-6">';
          html += '<p style="padding-top:10px"><b> '+outData.ProfessionalMemberships+'</b></p>';
          html += '</div>';
          html += '</div>';
          html += '</div>';       
          //html += '<div class="col-md-6 col-sm-6 col-xs-6"><div id="popMap" class="bkng_online_popup_map"></div></div>';
          ...
          html += '<div class="col-md-12 col-sm-12 col-xs-12" style=" background-color: #F2F2F2;border: 1px solid #e6e6e6;">';
          html += '<div class="bkng_popup_adrs_mainn">';
          html += '<div class="col-md-6 col-sm-6 col-xs-6"><h5  style="text-transform:none;">Awards</h5></div>';
          html += '<div class="col-md-6 col-sm-6 col-xs-6">';
          html += '<p style="padding-top:10px"><b> '+outData.Awards+'</b></p>';
          html += '</div>';
          html += '</div>';
          html += '</div>';       
          //html += '<div class="col-md-6 col-sm-6 col-xs-6"><div id="popMap" class="bkng_online_popup_map"></div></div>';
          ...
          html += '<div class="col-md-12 col-sm-12 col-xs-12" style=" background-color: #F2F2F2;border: 1px solid #e6e6e6;">';
          html += '<div class="bkng_popup_adrs_mainn">';
          html += '<div class="col-md-6 col-sm-6 col-xs-6"><h5  style="text-transform:none;">Insurance Plans</h5></div>';
          html += '<div class="col-md-6 col-sm-6 col-xs-6">';
          html += '<p style="padding-top:10px"><b> </b></p>';
          html += '</div>';
          html += '</div>';
          html += '</div>';       
          //html += '<div class="col-md-6 col-sm-6 col-xs-6"><div id="popMap" class="bkng_online_popup_map"></div></div>';
...
$(".dr_getDirections").click(function(e){
  e.preventDefault();
