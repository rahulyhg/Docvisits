...
alert("in search.js ---- 1");
	...
	alert("in search.js ---- 6");
	if(loc_len > 1){
		AutoCenter();
	}
	alert("in search.js ---- 7");
	}
	...
	alert("in search.js ---- 8");
	loadData(1); // For first time page load default results
	alert("in search.js ---- 9");
